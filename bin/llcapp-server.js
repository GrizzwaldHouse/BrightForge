...
/**
 * LLCApp Server - Express HTTP API + Web Dashboard
 *
 ...
 *
 * Usage:
 *   llcapp-server                     Start on default port (3847)
 *   PORT=8080 llcapp-server           Start on custom port
 *
...
async function main() {
  ...
  app.listen(port, () => {
    console.log('');
    console.log('  ╔══════════════════════════════════════╗');
    console.log('  ║       LLCApp Server v2.1.0           ║');
    console.log('  ╚══════════════════════════════════════╝');
    console.log('');
