...
const VALID_CATEGORIES = ['provider_error', 'plan_error', 'apply_error', 'session_error', 'server_error', 'fatal', 'forge3d_error', 'bridge_error', 'gpu_error', 'orchestration_error', 'handoff_error', 'supervisor_error', 'pipeline_error', 'scene_error', 'world_error', 'gameplay_error', 'prototype_error'];
